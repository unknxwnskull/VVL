...
let currentIndex = 0;
const items = grid.querySelectorAll('.trending-item');
...
function renderDots() {
  ...
  for (let i = 0; i < totalPages; i++) {
    ...
    dot.className = 'carousel-dot' + (i === Math.floor(currentIndex / visibleItems) ? ' active' : '');
...
function updateCarousel() {
  ...
  if (currentIndex < 0) {
    currentIndex = (totalPages - 1) * visibleItems;
